...
export default function SalesOrdersPage() {
  ...
  if (view === 'form') {
    return (
      <CreateSalesOrderForm orgSlug={orgSlug} onBack={() => setView('empty')} />
    );
  }
          ...
          <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
            <div className="text-center">
              ...
              <p className="mt-3 text-sm text-slate-500">
                Create, Share, and Track Sales Orders. Anticipate Future Revenues
                and Keep Track of Order Fulfillment.
              </p>
            </div>
            ...
            >
              ...
              <div className="relative flex flex-col items-center gap-3">
                ...
                <span className="text-sm font-semibold text-white">Watch Demo Video</span>
              </div>
            </a>
      ...
      <div className="mx-auto max-w-5xl px-6 py-8">
        <div className="mb-6 rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
          <div className="flex items-center gap-2 text-sm text-slate-500">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-slate-900">Bulk Upload Sales Order</span>
          </div>
...
function CreateSalesOrderForm({
  ...
  const [orderNo, setOrderNo] = useState('A00001');
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        <div className="mt-5 rounded-2xl border border-slate-200 bg-white px-6 py-8 shadow-sm">
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-[160px_1fr] items-center gap-4">
                <label className="border-b border-dashed border-slate-300 pb-1 text-sm font-bold text-slate-900">
                  Sales Order No<span className="text-red-600">*</span>
                </label>
                <input
                  value={orderNo}
              ...
              <div className="grid grid-cols-[160px_1fr] items-center gap-4">
                <label className="border-b border-dashed border-slate-300 pb-1 text-sm font-bold text-slate-900">
                  Sales Order Date<span className="text-red-600">*</span>
                </label>
          ...
          <div className="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-2">
            <PartyCard title="Sales Order From" subtitle="Your Details">
            ...
            <PartyCard title="Sales Order For" subtitle="Client's Details">
                  ...
                  <div className="grid grid-cols-[2fr_90px_90px_90px_110px_90px_110px_40px] items-center gap-2 text-sm">
                    ...
                    <div className="flex items-center justify-end gap-1">
                      <input
                        ...
                        value={l.taxRate}
                        onChange={(e) =>
                          updateLine(l.id, 'taxRate', Number(e.target.value))
                        }
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-4 pl-6 text-xs">
                    ...
                    <div className="relative">
                      <select
                        value={l.unit}
                        onChange={(e) =>
                          updateLine(l.id, 'unit', e.target.value as LineItem['unit'])
                        }
            ...
            {advancedOpen && (
              <div className="space-y-5 border-t border-slate-200 px-5 py-5">
                ...
                <div className="space-y-2.5">
                  ...
                  />
                  <AdvancedCheckbox
                    label="Show SKU in Sales Order"
                    checked={adv.showSkuInOrder}
                    onChange={(v) => setAdvField('showSkuInOrder', v)}
                  />
                  <AdvancedCheckbox
                    label="Show Serial Numbers in Sales Order"
