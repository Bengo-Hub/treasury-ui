...
const DEMO_VIDEO_URL = 'https://youtu.be/6TS_cmxB_Tc?si=jn4yxnb1vsN0hB7R';
    ...
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="mb-8 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="font-medium text-slate-900">Proforma Invoices</span>
        </div>

        <div className="flex items-center justify-center py-10">
          <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-slate-900">Proforma Invoices</h2>
              <p className="mt-3 text-sm text-slate-500">
                Create Proforma Invoices With Customisable Templates. 1-click Share
                via PDF, Print, or Link over WhatsApp or Email. Record & Track
                Payments. And more...
              </p>
            </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-8">
        <div className="mb-6 rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
          <div className="flex items-center gap-2 text-sm text-slate-500">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-slate-900">Bulk Upload Proforma Invoice</span>
          </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        <div className="mt-5 rounded-2xl border border-slate-200 bg-white px-6 py-8 shadow-sm">
          ...
          <div className="mt-8 flex items-start gap-4 rounded-xl border border-slate-200 bg-white p-5">
            ...
            <div>
              <p className="text-sm font-bold text-slate-900">
                This is a Recurring proforma invoice
              </p>
              <p className="mt-1 text-xs text-slate-500">
                A draft proforma invoice will be created with the same details every
                next period.
              </p>
            </div>
          </div>
            ...
            {advancedOpen && (
              <div className="space-y-5 border-t border-slate-200 px-5 py-5">
                ...
                <div className="space-y-2.5">
                  ...
                  />
                  <AdvancedCheckbox
                    label="Show SKU in Proforma Invoice"
                    checked={adv.showSkuInInvoice}
                    onChange={(v) => setAdvField('showSkuInInvoice', v)}
                  />
                  <AdvancedCheckbox
                    label="Show Serial Numbers in Proforma Invoice"
