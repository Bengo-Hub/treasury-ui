...
export function listAccounts(tenantIdOrSlug: string, params?: Record<string, string>): Promise<AccountsResponse> {
  return apiClient.get<AccountsResponse>(`${BASE}/${tenantIdOrSlug}/ledger/chart-of-accounts`, params);
}
