...
import { Ban, Copy, ExternalLink, RefreshCw, Trash2 } from 'lucide-react';
...
export default function PaymentReceiptsPage() {
  ...
  if (showCreate) {
    return <SharedDocumentCreateView effectiveTenant={src.docTenant} docType="payment_receipt" onClose={() => setShowCreate(false)} />;
  }
