...
/** BooksBalancedBadge — a compact GL-health pill from the trial balance (ΣDr == ΣCr). */
export function BooksBalancedBadge({ tenant }: Props) {
  ...
  return (
    <span
      ...
      title={balanced ? 'Trial balance is balanced' : 'Trial balance is OUT of balance — review the GL'}
    >
